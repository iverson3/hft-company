							...
							<div>
								...
								<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption"><i class="icon-edit"></i> 职位申请信息列表</div>
									</div>
										...
										<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
											...
											<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody>
													<tr class="">
														...
														<td><?php echo ($vo["degrees"]); ?></td>
														<td><?php echo ($vo["graduate_school"]); ?></td>
														<td class="center"><?php echo ($vo["major"]); ?></td>
														<td><?php echo ($vo["job"]); ?></td>
														<td><a id="look" href="__APP__/Jobs/apply_cont/id/<?php echo ($vo["id"]); ?>"><span class="icon-arrow-right"></span></a></td>
														<td><a class="delete" href="__APP__/Jobs/delete_apply/id/<?php echo ($vo["id"]); ?>"><span class="glyphicon glyphicon-remove"></span></a></td>
													</tr>
