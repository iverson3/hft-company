							...
							<div>
								...
								<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption"><i class="icon-edit"></i> 招聘信息列表</div>
									</div>
									<div class="portlet-body">
										<div class="clearfix">
											<div class="btn-group">
												<a id="sample_editable_1_new" class="btn green" href="__APP__/Jobs/add">&nbsp;新 建&nbsp;&nbsp;&nbsp;<i class="icon-plus"></i></a>
											</div>
										...
										<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
											...
											<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody>
													<tr class="">
														...
														<td><a class="edit" href="__APP__/Jobs/update/id/<?php echo ($vo["id"]); ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
														<td><a class="delete" href="__APP__/Jobs/delete/id/<?php echo ($vo["id"]); ?>"><span class="glyphicon glyphicon-remove"></span></a></td>
													</tr>
