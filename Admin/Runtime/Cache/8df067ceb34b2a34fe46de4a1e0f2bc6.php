			...
			<div class="container-fluid">
				...
				<div id="dashboard">
					<div class="portlet-title">
						<div class="caption"><i class="icon-edit"></i> 招聘信息修改</div>
					</div>
					<div class="clearfix"></div>
					<div class="row-fluid">
						<div id="main-content">
							<?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><form method="post" action="__APP__/Jobs/do_update">
								<table class="table table-bordered">
									...
									<tr>
										...
										<td><input type="number" class="form-control" name="numbers" value="<?php echo ($vo["numbers"]); ?>"></td>
									</tr>
									<tr>
										<td class="td-divs">工作性质: </td>
										<td><input type="text" class="form-control" name="type" value="<?php echo ($vo["type"]); ?>"></td>
									</tr>
									<tr>
										<td class="td-divs">工作经验: </td>
										<td><input type="text" class="form-control" name="experience" value="<?php echo ($vo["experience"]); ?>"></td>
									</tr>
									<tr>
										<td class="td-divs">工作地点: </td>
										<td><input type="text" class="form-control" name="area" value="<?php echo ($vo["area"]); ?>"></td>
									</tr>
									<tr>
										<td class="td-divs">学历要求: </td>
										<td><input type="text" class="form-control" name="degrees" value="<?php echo ($vo["degrees"]); ?>"></td>
									</tr>
									<tr>
										<td class="td-divs">工资待遇: </td>
										<td><input type="text" class="form-control" name="treatment" value="<?php echo ($vo["treatment"]); ?>"></td>
									</tr>
									<tr>
										<td class="td-divs">发布日期: </td>
										<td><input type="text" class="form-control" readonly name="create_time" value="<?php echo ($vo["create_time"]); ?>"></td>
									</tr>
									<tr>
										<td class="td-divs">截止日期: </td>
										<td><input type="date" class="form-control" name="end_time" value="<?php echo ($vo["end_time"]); ?>"></td>
									</tr>
									<tr>
										<td class="td-divs">职位描述及要求: </td>
										<td>
											<!-- ueditor文本编辑器 -->
											<script id="editor" name="describe_require" type="text/plain" style="">
											<?php echo ($vo["describe_require"]); ?></script>
										</td>
									</tr>
									<tr>
										<td class="td-divs">联系电话: </td>
										<td><input type="text" class="form-control" name="tel" value="<?php echo ($vo["tel"]); ?>"></td>
									</tr>
									<tr>
