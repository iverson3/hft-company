							...
							<div>
								...
								<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption"><i class="icon-edit"></i> 下载资源列表</div>
									</div>
									<div class="portlet-body">
										<div class="clearfix">
											<div class="btn-group">
												<a href="__APP__/Download/up" class="btn icn-only green">&nbsp;去上传&nbsp;&nbsp;&nbsp;<i class="m-icon-swapright m-icon-white"></i></a>
											</div>
										</div>
										<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
											...
											<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody>
													<tr class="">
														...
														<td><?php echo ($vo["real_filename"]); ?></td>
														<td><?php echo ($vo["filesize"]); ?></td>
														<td><?php echo ($vo["update_time"]); ?></td>
														<td class="center"><?php echo ($vo["download_times"]); ?></td>
														<td><a class="edit" href="__APP__/Download/update/id/<?php echo ($vo["id"]); ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
														<td><a class="delete" href="__APP__/Download/delete/id/<?php echo ($vo["id"]); ?>"><span class="glyphicon glyphicon-remove"></span></a></td>
													</tr>
